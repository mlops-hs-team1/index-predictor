...
if __name__ == "__main__":
    ...
    parser.add_argument("--import-config", type=str, default="src/deployment/config.json")
    parser.add_argument("--export-config", type=str, default="src/deployment/config-export.json")
    parser.add_argument("--export-params", type=str, default="src/deployment/params-export.json")
    parser.add_argument("--export-tags", type=str, default="src/deployment/tags-export.json")
